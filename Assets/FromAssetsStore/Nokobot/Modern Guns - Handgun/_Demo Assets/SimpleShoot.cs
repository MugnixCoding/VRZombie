...
public class SimpleShoot : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (socketInteractor != null)
        {
            ...
            socketInteractor.selectEntered.AddListener(RemoveMagazine);
        }
        if (magazine!=null)
        {
            hasSlided = true;
    ...
    {
        if (magazine && magazine.NumberOfBullet > 0 && hasSlided)
        {
    ...
    public void RemoveMagazine(SelectEnterEventArgs e)
    {
        magazine = null;
        audioSource.PlayOneShot(reloadSound);
    }
